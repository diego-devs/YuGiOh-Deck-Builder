...
namespace YugiohDB.Migrations
{
    ...
    [Migration("20260425031937_FavoriteCardUseKonamiId")]
    partial class FavoriteCardUseKonamiId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YGODeckBuilder.Data.EntityModels.FavoriteCard", b =>
                {
                    ...
                    b.HasIndex("KonamiCardId", "UserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("YGODeckBuilder.Data.EntityModels.UserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YGODeckBuilder.Data.EntityModels.FavoriteCard", b =>
                {
                    b.HasOne("YGODeckBuilder.Data.EntityModels.UserAccount", "User")
                        .WithMany()
