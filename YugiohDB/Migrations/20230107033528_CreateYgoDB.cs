    ...
    public partial class CreateYgoDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BanlistId = table.Column<int>(name: "Banlist_Id", type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CardId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    KonamiCardId = table.Column<int>(type: "int", nullable: true),
                    ...
                    BanlistInfoBanlistId = table.Column<int>(name: "BanlistInfoBanlist_Id", type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.BanlistInfoBanlistId,
